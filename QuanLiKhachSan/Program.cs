...
namespace QuanLiKhachSan
{
    public class Program
    {
        ...
        public static void TaodsNhanVien()
        {
            ...
            dsNhanVien.Add(new NhanVien("NV012", "Thai Tao Lao", "0943181202", "2345342342", dsNhomNhanVien[1], dsCongViec[2]));
        ...
        public static void Tan2()
        {
            ...
            Console.WriteLine("Gia tien khach hang tra lon nhat: " + max);
           foreach(var n in kh)
            {
                Console.WriteLine(n);
            }
